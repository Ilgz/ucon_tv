...
class Channels{
  ...
  static String nativeAll="";
  static String nativeChild="";
  static String nativeFilm="";
  static String nativeNews="";
  static String nativeCog="";
  static String nativeSport="";
  static String nativeMusic="";
  static String nativeInter="";
}
...
List<ChannelItemModel> getChannels() {
  ...
  listChannels.add(ChannelItemModel("Жаша! HD","https://i.ibb.co/XVjg88x/image.jpg"));
  listChannels.add(ChannelItemModel("Super TV HD","https://i.ibb.co/9HctSLk/super-tv.jpg"));
  ...
  listChannels.add(ChannelItemModel("ЭлТР Кыргызстан","https://i.ibb.co/BfFxWP7/1.jpg"));
  listChannels.add(ChannelItemModel("5 Канал","https://i.ibb.co/3MNdqrj/5.jpg"));
  listChannels.add(ChannelItemModel("Manas HD","https://i.ibb.co/ykDg0Gn/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("Fashion TV","https://i.ibb.co/z6v76By/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("Здоровое ТВ","https://i.ibb.co/N1STcyW/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("ТВЦ","https://i.ibb.co/mJvnZPQ/1.jpg"));
  listChannels.add(ChannelItemModel("312 ТВ","https://i.ibb.co/WtSgm67/312.jpg"));
  listChannels.add(ChannelItemModel("312 Кино HD","https://i.ibb.co/vX9vgyt/312.jpg"));
  ...
  listChannels.add(ChannelItemModel("БелРос","https://i.ibb.co/Qb7mxTB/image.jpg"));
  listChannels.add(ChannelItemModel("RTG TV","https://i.ibb.co/nzk2Pp5/rtg.jpg"));
  listChannels.add(ChannelItemModel("E TV","https://i.ibb.co/Jr6TRxn/e-tv.jpg"));
  ...
  listChannels.add(ChannelItemModel("Setanta Sport 1 HD", "https://i.ibb.co/vBsDzvv/111.jpg"));
  listChannels.add(ChannelItemModel("Setanta Sport 2 HD", "https://i.ibb.co/0yV27Rx/22.jpg"));
  listChannels.add(ChannelItemModel("Setanta Kyrgyzstan", "https://i.ibb.co/Lkbd5W3/Setanta-Kyrg.jpg"));
  ...
  listChannels.add(ChannelItemModel("Бокс ТВ","https://i.ibb.co/GcXhdJf/1.jpg"));
  ...
  listChannels.add(ChannelItemModel("Моторспорт ТВ","https://i.ibb.co/Tv0W6d0/motorsport.jpg"));
  listChannels.add(ChannelItemModel("Sport UZ","https://i.ibb.co/C1RYMxs/sport-uz.jpg"));
  listChannels.add(ChannelItemModel("Кино ТВ","https://i.ibb.co/PTDY7Lv/image.jpg"));
  listChannels.add(ChannelItemModel("CineMax","https://i.ibb.co/p1Vhjhq/CM.jpg"));
  listChannels.add(ChannelItemModel("Cinema","https://i.ibb.co/HKp9P6q/cinema.jpg"));
  listChannels.add(ChannelItemModel("NUR TV HD","https://i.ibb.co/MggTD61/nur-tv.jpg"));
  ...
  listChannels.add(ChannelItemModel("Кинопремьера","https://i.ibb.co/GHMpF6n/image.jpg"));
  listChannels.add(ChannelItemModel("Киносвидание","https://i.ibb.co/TTN2nyg/image.jpg"));
  listChannels.add(ChannelItemModel("Киносемья","https://i.ibb.co/4Ww2vpX/image.jpg"));
  listChannels.add(ChannelItemModel("Кинохит","https://i.ibb.co/w6TmF86/image.jpg"));
  listChannels.add(ChannelItemModel("Киномикс","https://i.ibb.co/7yGTqYq/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("Мужское кино","https://i.ibb.co/B4PZSNg/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("TV1000","https://i.ibb.co/N14JdDp/tv1000-2.jpg"));
  listChannels.add(ChannelItemModel("TV1000 Action","https://i.ibb.co/bNkNnYF/TV1000-Action.jpg"));
  listChannels.add(ChannelItemModel("TV1000 Русское кино","https://i.ibb.co/26HskgL/TV1000.jpg"));
  listChannels.add(ChannelItemModel("Амедия Хит HD","https://i.ibb.co/sP7BXk7/amedia-hit.jpg"));
  ...
  listChannels.add(ChannelItemModel("Дом кино Премиум HD","https://i.ibb.co/CPMvvkf/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("Euronews Russia","https://i.ibb.co/vxrvVrb/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("Nick Junior","https://i.ibb.co/gJLvkdn/nick-jr.jpg"));
  listChannels.add(ChannelItemModel("Nick Toons","https://i.ibb.co/yfMz3mD/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("Мультландия","https://i.ibb.co/ZMtYYDn/image.jpg"));
  listChannels.add(ChannelItemModel("Мульт","https://i.ibb.co/m0HxsPb/image.jpg"));
  listChannels.add(ChannelItemModel("DaVinci Learning","https://i.ibb.co/vvqg8sw/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("TRT Çocuk ","https://i.ibb.co/rxP4731/trt-cocuk.jpg"));
  ...
  listChannels.add(ChannelItemModel("Bridge TV Hits","https://i.ibb.co/k0k49CX/bridgetvhits.jpg"));
  listChannels.add(ChannelItemModel("Bridge TV","https://i.ibb.co/M7r1Fs7/bridgetv.jpg"));
  ...
  listChannels.add(ChannelItemModel("МузТВ","https://i.ibb.co/109SprY/image.jpg"));
  listChannels.add(ChannelItemModel("Россия Культура","https://i.ibb.co/GF2cCCq/image.jpg"));
  listChannels.add(ChannelItemModel("Вопросы Ответы","https://i.ibb.co/gdJC8DN/image.jpg"));
  listChannels.add(ChannelItemModel("Живая планета","https://i.ibb.co/0XZyf0R/image.jpg"));
  listChannels.add(ChannelItemModel("Канал История","https://i.ibb.co/w7g2Sgd/image.jpg"));
  ...
  listChannels.add(ChannelItemModel("Наука","https://i.ibb.co/Vt1QZ1d/2-0.jpg"));
  ...
  listChannels.add(ChannelItemModel("TRT World","https://i.ibb.co/jRc4wcj/trt-world.jpg"));
  ...
  listChannels.add(ChannelItemModel("Хабар","https://i.ibb.co/WDPX13L/kazakh-tv.jpg"));
  ...
  listChannels.add(ChannelItemModel("CNN","https://i.ibb.co/7tzPTDw/CNN-int.jpg"));
  listChannels.add(ChannelItemModel("Museum TV HD","https://i.ibb.co/wLFJsDj/museum.jpg"));
