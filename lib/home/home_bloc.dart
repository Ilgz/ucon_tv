...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  Future<List<Film>> getUpdates(
      http.Client client, String category, String initial_repo) async {
    List<Film> finalList = [];
    int premierPage = 1;
    while (finalList.isEmpty || (finalList.length % 20) == 0) {
      ...
      final title = html
          ...
          .toList();
      final image = html
          .getElementsByClassName("xfieldimage mini_poster")
          .map((e) => e.attributes['src'])
          .toList();
      final site = html
          .getElementsByClassName("custom1-img")
